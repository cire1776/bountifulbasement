...
function DaySchedule({date,events,status}) {
    ...
    if(events===null) {
        return <aside className="day-schedule">
            <h1>{date}</h1>
            <h2>Loading...</h2>
            </aside>;
    }
    ...
    return (
        <aside className="day-schedule">
            ...
            {      
                status === 'delivery' && <h2 className="primary">10:00-2:00 Bountiful Basement Delivery</h2>
            }
            {
                status === 'open-morning' && <h2 className="primary">9:30-12:00 Bountiful Basement Open</h2>
            }
            {
                status === 'open-evening' && <h2 className="primary">5:00-6:45 Bountiful Basement Open</h2>
            }
